...
Working directory: ${params.SOURCE_DIRECTORY}
                    ...
                    if ("${BRANCH}" =~ /^(master|develop|feature*)/) {
                        if (fileExists("${params.SOURCE_DIRECTORY}/dockerfiles/build")) {
                            ...
                            sh "docker image build ${LATEST_NGINX_DOCKER_ARGS} ${params.SOURCE_DIRECTORY}/laradock/nginx" 
                            ...
                            sh "docker image build ${LATEST_MYSQL_DOCKER_ARGS} ${params.SOURCE_DIRECTORY}/laradock/mysql" 
